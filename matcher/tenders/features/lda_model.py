...
class LDAModel:
    ...
    def add_lda_result_to_data(self):
        self.relevant_tenders.loc[:, 'keywords'] = self.relevant_tenders.apply(self.extract_keyword, axis=1)
        self.relevant_tenders.loc[:, 'topics'] = self.relevant_tenders.apply(self.get_doc_topic, axis=1)
